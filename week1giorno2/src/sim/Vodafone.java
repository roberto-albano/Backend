...
public class Vodafone {
	...
	public void stampaDati() {
		...
		// Controlla se la chiamata � presente nella posizione indicata, altrimenti potrei avere un errore
		// in costrutto if verr� speigato in dettaglio nelle lezioni successive
